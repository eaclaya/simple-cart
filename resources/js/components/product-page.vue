                                    ...
                                    >
                                        <div class="space-y-4">
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        class="bg-white/60 p-4 text-base sm:text-sm"
                                                    >
                                                        <a
                                                            :href="item.href"
            ...
            <div class="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
                ...
                <div class="mt-8 lg:col-span-5">
                    <form>
                            ...
                            <fieldset aria-label="Choose a size" class="mt-2">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        />
                                        <span
                                            class="text-sm font-medium text-gray-900 uppercase group-has-[:checked]:text-white"
                                            >{{ size.name }}</span
                                        >
                                    </label>
                                </div>
                        ...
                        <button
                            type="submit"
                            class="mt-8 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none"
                        >
                            Add to cart
                        </button>
                    </form>
            ...
            <section aria-labelledby="reviews-heading" class="mt-16 sm:mt-24">
                ...
                >
                    <div
                        ...
                        :key="review.id"
                        class="py-10 lg:grid lg:grid-cols-12 lg:gap-x-8"
                    >
                        <div
